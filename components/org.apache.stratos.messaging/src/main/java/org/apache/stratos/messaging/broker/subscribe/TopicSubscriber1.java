 ...
 * 
 */
public class TopicSubscriber1 implements Runnable {

	private static final Log log = LogFactory.getLog(TopicSubscriber1.class);
	 ...
	 */
	public TopicSubscriber1(String aTopicName) {
