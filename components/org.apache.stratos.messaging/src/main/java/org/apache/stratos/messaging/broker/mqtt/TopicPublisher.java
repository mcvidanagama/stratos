...
package org.apache.stratos.messaging.broker.mqtt;
...
public class TopicPublisher {
	...
	public static synchronized TopicPublisher getTopicPublisher() {
		if (topicPub == null) {
			topicPub = new TopicPublisher();
		}
		return topicPub;
	...
	public void publish(String topic, Object messageObj, boolean retry) {
